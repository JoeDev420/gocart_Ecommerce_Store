...
const Footer = () => {
   ...
   const linkSections = [
    ...
    title: "PRODUCTS",
    links: [
        { text: "Shop All", path: "/shop", icon: null },
        { text: "Mouse", path: "/shop?category=Mouse", icon: null },
        { text: "Earbuds", path: "/shop?category=Earbuds", icon: null },
        { text: "Headphones", path: "/shop?category=Headphones", icon: null },
        { text: "Electronic Watches", path: "/shop?category=Electronic%20Watches", icon: null },
    ]
},
,
    {
    ...
    return (
        <footer className="mx-6 bg-white" id="contact">
